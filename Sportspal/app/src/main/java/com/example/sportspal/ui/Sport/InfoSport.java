...
public class InfoSport extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root = inflater.inflate(R.layout.fragment_info_sport, container, false);
        model = new ViewModelProvider(requireActivity()).get(SportViewModel.class);

        Button deleteSport = root.findViewById(R.id.sport_delete_button);
        Button updateSport = root.findViewById(R.id.sport_update_button);

        deleteSport.setOnClickListener(v -> deleteSportFromDataBase());

        updateSport.setOnClickListener(this::updateSportFromDatabase);

        TextView sport_name_textView = root.findViewById(R.id.sport_name_textView);
        TextView sport_id_textView = root.findViewById(R.id.sport_id_textView);
        TextView sport_gender_textView = root.findViewById(R.id.sport_gender_textView);
        TextView sport_type_textView = root.findViewById(R.id.sport_type_textView);
